...
const renderSortType = (sortTypes, currentSortType) => sortTypes.map((sortType) =>
  `<div class="trip-sort__item  trip-sort__item--${sortType.type}" >
    <input id="sort-${sortType.type}" class="trip-sort__input  visually-hidden" data-sort-type="${sortType.sortType}" type="radio" name="trip-sort" value="sort-${sortType.type}" ${currentSortType === sortType.type ? 'checked' : ''}${(sortType.additional) ? sortType.additional : ''}>

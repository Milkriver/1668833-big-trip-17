...
const createPointTemplate = (point) => {
  ...
  const date = dateFrom !== null ? humanizeTaskDueDate(dateFrom) : '';
  const timeFrom = dateFrom !== null ? humanizeTaskDueTime(dateFrom) : '';
  const timeTo = dateTo !== null ? humanizeTaskDueTime(dateTo) : '';
